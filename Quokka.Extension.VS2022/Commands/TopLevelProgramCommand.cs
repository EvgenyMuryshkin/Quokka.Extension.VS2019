...
namespace Quokka.Extension.VS2022
{
    internal class TopLevelProgramCommand : DynamicItemMenuCommandFactory
    {
        public TopLevelProgramCommand(
            ...
            ) : base(deps, invocationService, extensionsCacheService, guidQuokkaExtensionVS2022PackageIds.guidQuokkaExtensionVS2022PackageCmdSet, guidQuokkaExtensionVS2022PackageIds.cmdidMyDynamicStart_Program, TopLevelIcon.Program)
        {
        }
    }
}
